import{B as o,M as l,S as d,h as m}from"./login-9e36f44f.js";import{p}from"./pagination-008a36c2.js";import{u as f}from"./User-18220aaa.js";import{G as v}from"./Validation-8d628f68.js";var c=null;class n{constructor(){c=this,this.btnCreateFinalize=document.getElementById("createUserFinalize")}getSection(e){let i="";e.forEach(a=>{i+=`
          <option value="${a.id}">${a.section}</option>
        `}),document.getElementById("section").innerHTML=i}createUser(e,i){e.preventDefault();let a={};if(!v.form.form("is valid"))return 0;$("#formCreateUser :input").prop("readonly",!0),o.start(new n().btnCreateFinalize),$("#formCreateUser").serializeArray().forEach(s=>{a[s.name]=s.value}),f.createUser(a,s=>{o.load(document.getElementById("createUserFinalize"),()=>{new n().failedAction("formCreateUser"),i.table.ajax.reload(),l.success("User Successfully Created")},"REGISTER USER")},s=>{o.load(document.getElementById("createUserFinalize"),()=>{$("#formCreateUser .message").html(""),$("#formCreateUser :input").prop("readonly",!1),l.fail(s.message)},"REGISTER USER")})}failedAction(e){$("#"+e).form("reset"),$("#"+e+" .message").html(""),$("#"+e+" :input").prop("readonly",!1)}createUserAction(){var e=new n;d.getSection($("#division").val(),e.getSection),$("#modalCreate").modal("show")}sectionGetAction(e){var i=new n;d.getSection(e.target.value,i.getSection)}fetchUsers(e){e=e.data,console.log(e);let i="";e.forEach(a=>{i+=`
        ...
        `}),p.load(document.getElementById("page_content"),s,c.fetchUsersTable,"./api/users/getpage"),i.innerHTML=r}}new n;
