import{A as s}from"./login-ab27f3ad.js";class n{constructor(){this.msgEl=document.createElement("div"),this.msgEl.className="ui very tiny modal",this.msgEl.innerHTML=`
            <div class="content">
            </div>
        ...
        `,$(this.msgEl).modal("show")}hide(){$(this.msgEl).modal("hide").modal("hide dimmer")}}class o{constructor(i){this.element=document.getElementById(i)}destroy(i){$(i).removeClass("active"),console.log(i)}}new n;new o;document.addEventListener("DOMContentLoaded",()=>{document.getElementById("draft-editor-container"),$(".ui .dropdown").dropdown(),$("#logout_user").on("click",()=>{s.logout()})});
