import{A as s}from"./login-dacdc280.js";class n{constructor(){this.msgEl=document.createElement("div"),this.msgEl.className="ui very tiny modal",this.msgEl.innerHTML=`
            <div class="content">
            </div>
        ...
        `,$(this.msgEl).modal("show")}hide(){$(this.msgEl).modal("hide").modal("hide dimmer")}}class o{constructor(i){this.element=document.getElementById(i)}destroy(i){$(i).removeClass("active")}}new n;new o;document.addEventListener("DOMContentLoaded",()=>{document.getElementById("draft-editor-container"),$(".ui .dropdown").dropdown(),$("#logout_user").on("click",()=>{s.logout()})});
