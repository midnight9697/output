...
class PHearing {
  fetch_by_page(action, fail) {
      var usersClone = this;
      this.customGetRequest('./eia_corner/hearing/ps-data', action, fail);
  }

  insert(data,action, fail) {
    this.customPostURequest('./eia_corner/hearing/insert', data, action, fail);
  }
  
  update(data,action, fail) {
    this.customPostURequest('./eia_corner/hearing/update', data, action, fail);
  }

  remove(data,action, fail) {
    this.customPostURequest('./eia_corner/hearing/remove', {id: data}, action, fail);
  }
...
export const hearingController = new PHearing();