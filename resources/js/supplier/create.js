  ...
  global_place('supplier_province', 'supplier_municipality', 'supplier_barangay')
    ...
    SupplierValidator.CreateSupplierValidation((e) => {
        ...
        let data = {
            ...
            'supplier_latitude': SupplierValidator.serializeArrayToJson('.formCreateSupplier').supplier_latitude,
            'supplier_longitude': SupplierValidator.serializeArrayToJson('.formCreateSupplier').supplier_longitude,
        }
