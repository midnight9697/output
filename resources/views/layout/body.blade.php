...
<div class="ui visible sidebar vertical left inverted  menu main-sidebar" id="sidebar" style="background: #2C468C">
    ...
    <div class="item ">
        ...
        <div class="menu">
            ...
            {{ view('layout.menu', [ 'url' => url("division"), 'title' => 'Division', 'routesplit' => $routesplit, 'permission' => true]) }}
            {{ view('layout.menu', [ 'url' => url("bac"), 'title' => 'BAC', 'routesplit' => $routesplit, 'permission' => true]) }}
            {{ view('layout.menu', [ 'url' => url("inspector"), 'title' => 'Inspector', 'routesplit' => $routesplit, 'permission' => true]) }}
